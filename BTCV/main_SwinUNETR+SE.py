...
#from new_poolformer_unet import SwinUNETR
...
parser.add_argument("--logdir", default="swinunetr_12", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
...
def main_worker(gpu, args):
    ...
    post_label = AsDiscrete(to_onehot=14, n_classes=args.out_channels)
    post_pred = AsDiscrete(argmax=True, to_onehot=14, n_classes=args.out_channels)
