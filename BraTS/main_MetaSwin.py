...
parser.add_argument("--max_epochs", default=800, type=int, help="max number of training epochs")
...
parser.add_argument("--use_normal_dataset", default=True, help="use normal data")
parser.add_argument(
    "--pretrained_dir",
